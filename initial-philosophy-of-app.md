...
<p>
A few terms can be under a layer. Any sub terms or micro terms will go under the layer. Only a few or only one thread will be welcomed by the app, since we can't handle more than one. We will count processes</p>

<p>We will count users frequency of coming to a topic, wave/chart of their whole career of learning and doing. Only todo based learning. We learn because we are doing something. Priority is activity or projects</p>
...
A book is being written. I am not sharing propaganda and economics based research
 here, cause I am not sure what they will do here. But certainly I will figure out how they can help</p>
